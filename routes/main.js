...
router.post("/", async (req, res) =>{
	...
	var queryParameters = { apikey:'2fy7Z6sBixoc7pkl5aPzRL4AVWNVmtyF', postalCode:req.body['Payload']['postalCode'], startdateTime: req.body['Payload']['startDateTime'], endDateTime: req.body['Payload']['endDateTime'], size: '200' };
	var locations = []
	try{
